...
class CtrlAltCanoeImage extends PolymerElement {
  static get template() {
    return html`
    <style>
      ...
      img {
        ...
        @apply --ctrl-alt-canoe-image-img;
      }
...
`;
  ...
  static get is() { return 'ctrl-alt-canoe-image'; }
...
customElements.define(CtrlAltCanoeImage.is, CtrlAltCanoeImage);
