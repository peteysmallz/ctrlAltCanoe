...
class CtrlAltCanoeCategoryData extends PolymerElement {

  static get is() { return 'ctrl-alt-canoe-category-data'; }
...
customElements.define(CtrlAltCanoeCategoryData.is, CtrlAltCanoeCategoryData);
